...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.prism = new MyPrism(this, 50, 100);
        ...
        this.globalAmbientLightIntensity = 0.3; // valor inicial 
    ...
    updateAmbientLight() {
        this.setGlobalAmbientLight(
            this.globalAmbientLightIntensity, 
            this.globalAmbientLightIntensity, 
            this.globalAmbientLightIntensity, 
            1.0
        );
    ...
    initMaterials() {
        ...
        // Wood Material (Novo Material)
        this.materialWood = new CGFappearance(this);
        this.materialWood.setAmbient(0.2, 0.1, 0.05, 1.0);  
        this.materialWood.setDiffuse(0.5, 0.25, 0.1, 1.0);  
        this.materialWood.setSpecular(0.1, 0.05, 0.02, 1.0); 
        ...
        this.materials = [this.material1, this.material2, this.material3, this.materialWood, this.customMaterial];
